...
from .worker import create_and_run
...
def main():
    ...
    parser = argparse.ArgumentParser(
        prog="Rdps", 
        description="Harness the power of RD from the command line"
    )
    ...
    run_parser = subparsers.add_parser(
        "run",
        help="Run a RD Pub/Sub worker with auto-discovery of subs modules in the "
    ...
    run_parser.add_argument(
        ...
        default=None,
        required=False,
        help="Settings file dot path. Ex. core.settings. "
        "If none is supplied, RD Pub/Sub will attempt to autodiscover in the root path.",
    )
    run_parser.add_argument(
