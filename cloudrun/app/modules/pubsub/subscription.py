...
class Subscription:
    ...
    For example::
        ...
        from app.rdps import Subscription
    ...
    If ``rdps-cli run`` is used, the ``DoSomethingSub`` will be a valid subscription
...
class Callback:
    ...
    def __call__(self, message):
        ...
        try:
            res = self._subscription(data, **dict(message.attributes, message_id=message.message_id))
...
def sub(
    ...
    Usage::
        ...
        def sub_process_landscape_mindsets(data, **kwargs):
            pass
    ...
    :param retry_policy: obj :class:`~rdps.retry_policy.RetryPolicy`
    :return: :class:`~rdps.subscription.Subscription`
    """
