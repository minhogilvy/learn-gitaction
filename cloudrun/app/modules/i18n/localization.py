...
class TranslationWrapper:
    ...
    def __new__(cls, lang: str = 'en'):
        ...
        if cls._instance is None:
            ...
            cls._instance.init_translation(lang)
        return cls._instance

    def init_translation(self, lang: str = 'en'):
        """
...
def t(message: str, lang: str = 'en') -> str:
    """
    Get the translated string for the specified message.
    ...
    Returns:
        str: The translated string.
    """
    translation_wrapper = TranslationWrapper(lang=lang)
